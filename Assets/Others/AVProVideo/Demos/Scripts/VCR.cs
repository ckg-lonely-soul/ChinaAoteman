...
namespace RenderHeads.Media.AVProVideo.Demos
{
    public class VCR : MonoBehaviour
    {
        ...
        public ApplyToMesh _mediaDisplay;  //1234
        ...
        public MediaPlayer.FileLocation _location = MediaPlayer.FileLocation.RelativeToPeristentDataFolder;
        ...
        public void OnOpenVideoFile()
        {
            ...
            _VideoIndex = (_VideoIndex + 1) % (_videoFiles.Count);
